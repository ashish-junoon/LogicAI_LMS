        ...
        <div>
            ...
            <div className="relative">
                ...
                <select
                    name={name}
                    id={id}
                    className={`bg-white border text-sm border-gray-300 text-gray-800 text-md rounded focus:ring-1 focus:ring-primary focus:border-primary block w-full ${icon ? "pl-10" : "px-2"} p-1 focus:shadow-sm focus:outline-light ${disabled ? " bg-zinc-100" : ""}`}
                    onChange={onChange}
                    onBlur={onBlur}
