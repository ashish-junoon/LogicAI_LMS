...
import { SectionCard } from "./Helper";
  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <SectionCard
          title="NPA Count by Top Sectors"
          subtitle="Absolute NPA volume"
          accent="bg-red-500"
        >
          {!isLoading?.loading2 ? (
            <div className="relative max-h-[320px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <SectionCard
          title="House Type Split"
          subtitle="Owned vs Rented borrowers"
        ...
        >
          {!isLoading?.loading4 ? (
            <>
              ...
              <div className="mt-4 space-y-1.5 rounded-xl bg-slate-50 p-3 text-xs leading-relaxed text-slate-500">
