...
export const KpiCard = ({ icon, label, value, sub, type }) => {
  ...
  return (
    <div className="group rounded-lg border border-slate-200 bg-gradient-to-br from-primary/20 to-primary/5 px-4 py-3 transition-all duration-200 hover:border-slate-300 hover:shadow-md">
