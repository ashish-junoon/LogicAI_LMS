        ...
        <>
            <div className='flex-1 h-full border border-gray-200 shadow-sm rounded-lg bg-gray-50'>
                ...
                <div className='flex justify-between p-3 px-4 bg-gray-100 rounded-t-lg'>
                    ...
                    <button onClick={() => setIsModalOpen(true)} className='p-2 px-4 rounded-sm bg-blue-600 text-white flex justify-between gap-3'> New State <IoMap className='self-center' /></button>
                </div>
