...
import { branchData, branchManagerData, cityData, relationshipData, stateData } from '../../content/masterData'
        ...
        <>
            <div className='flex-1 h-full border border-gray-200 shadow-sm rounded-lg bg-gray-50'>
                ...
                <div className='flex justify-between p-3 px-4 bg-gray-100 rounded-t-lg'>
                    ...
                    <button onClick={() => setIsModalOpen(true)} className='p-1.5 px-3 rounded-sm bg-primary hover:bg-primary/90 text-white flex justify-between gap-3'> New City <IoMap className='self-center' /></button>
                </div>
